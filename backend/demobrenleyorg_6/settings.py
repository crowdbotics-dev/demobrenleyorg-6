"""
Django settings for demobrenleyorg_6 project.
...
ROOT_URLCONF = 'demobrenleyorg_6.urls'
...
WSGI_APPLICATION = 'demobrenleyorg_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demobrenleyorg_6 API",
    "DESCRIPTION": "API documentation for demobrenleyorg_6 App",
    "VERSION": "v1",
}
